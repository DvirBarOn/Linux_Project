# דף הכנה לבחינה על פרויקט הגרפים

המסמך הזה מרכז בצורה מסודרת את כל מה שחשוב לדעת לקראת הבחינה על הפרויקט,
במיוחד אם תעבוד על מחשב אחר בסביבת לינוקס ולא על המחשב האישי שלך.

---

## 1. מה חשוב להבין על סביבת הבחינה
...
- תבחר לממש אחת מהן
- יש לך שעה אחת
- אחר כך תהיה הערכת עמיתים

לפי שיטת הניקוד, חשוב לעבוד חכם:

- **35%** על זיהוי נכון של המקום בקוד שצריך לשנות
- **30%** על קוד הגיוני שמממש את השינוי, גם אם לא מושלם
- **20%** על `commit` שעובד בפועל ב-GitHub
- **15%** על הערכת עמיתים אמינה

המסקנה הכי חשובה:
לא חייבים להספיק הכול מושלם, אבל כן חייבים:
- להבין איפה לשנות
- לעשות שינוי הגיוני
- להספיק `commit` ו-`push`

---

## 3. מבנה החשיבה הנכון בבחינה
...
## 4. הפקודות החשובות ביותר בלינוקס
...
זה מספיק לחלוטין לבחינה.

---

## 6. מפת הקבצים הכי חשובה לזכור
...
## 7. איך לזהות מהר איפה צריך לשנות
...
## 8. פקודות grep שמאוד יעזרו בבחינה
...
## 11. מה לעשות קודם לפי שיטת הניקוד
...
## 17. סט משימות דוגמה שיכולות להתאים לבחינה (משימות 1–5)

המטרה של הסעיף הזה היא לעזור לך לתרגל מראש את צורת החשיבה של הבחינה:
...
## 18. איך לעבוד עם משימות דוגמה כאלה בבחינה
...
## 19. מסקנה לגבי משימות 1–5

אם תבין טוב את חמש המשימות האלה, תהיה לך הכנה טובה מאוד לרוב המשימות הסבירות בבחינה, כי הן יושבות בדיוק על הלב של הפרויקט:
